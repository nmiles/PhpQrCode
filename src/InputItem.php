...
class InputItem
{
    ...
    public function encodeModeNum($version)
    {
        try {
            ...
            $val = 0x1;
            $bs->appendNum(4, $val);
            $bs->appendNum(Spec::lengthIndicator(Str::QR_MODE_NUM, $version), $this->size);
    ...
    public function encodeMode8($version)
    {
        try {
            ...
            $bs->appendNum(4, 0x4);
            $bs->appendNum(Spec::lengthIndicator(Str::QR_MODE_8, $version), $this->size);
    ...
    public function estimateBitStreamSizeOfEntry($version)
    {
        ...
        switch ($this->mode) {
            ...
            case Str::QR_MODE_STRUCTURE:
                return static::STRUCTURE_HEADER_BITS;
            default:
                return 0;
        }
