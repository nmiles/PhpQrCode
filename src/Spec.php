...
class Spec
{
    ...
    {
        return self::$capacity[$version][static::QRCAP_WORDS] - self::$capacity[$version][static::QRCAP_EC][$level];
    }


    public static function getECCLength($version, $level)
    {
        return self::$capacity[$version][static::QRCAP_EC][$level];
    }


    public static function getWidth($version)
    {
        return self::$capacity[$version][static::QRCAP_WIDTH];
    }


    public static function getRemainder($version)
    {
        return self::$capacity[$version][static::QRCAP_REMINDER];
    }
    ...
    public static function getMinimumVersion($size, $level)
    {
        ...
        for ($i = 1; $i <= static::QRSPEC_VERSION_MAX; $i++) {
            $words = self::$capacity[$i][static::QRCAP_WORDS] - self::$capacity[$i][static::QRCAP_EC][$level];
            if ($words >= $size)
                return $i;
        }
     ...
     * @param mixed $frame
     * @param mixed $ox
     * @param mixed $oy upper-left coordinate of the pattern
     */
